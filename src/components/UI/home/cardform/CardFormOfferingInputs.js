...
class CardFormOfferingInputs extends Component {
  ...
  componentDidUpdate() {
    ...
    if (
      this.props.openOfferingId !== this.state.id &&
  ...
  onImageChangeHandler = (event) => {
    ...
    this.props.uploadOfferingImages(images, offeringId);
        ...
        {this.state.showOffering ? (
          <div className="card-form-products-services-container">
            ...
            <div className="card-form-product-service-buttons-container">
              ...
              >
                {(this.props.offeringImageLoader.loading &&
                  this.props.offeringImageLoader.offeringId) ===
                this.state.id ? (
                  <Loader
                    type="TailSpin"
                    color="#2ecc71"
              ...
              >
                {(this.props.offeringLoader.deletingLoader &&
                  this.props.offeringLoader.deletingOfferingId) ===
                this.state.id ? (
                  <Loader
                    type="TailSpin"
                    color="#2ecc71"
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    uploadOfferingImages: (images, offeringId) =>
      dispatch(uploadOfferingImages(images, offeringId)),
    deleteOfferingImage: (photoId, offeringId) =>
      dispatch(deleteOfferingImage(photoId, offeringId)),
  };
};
