      ...
      <div className="review-modal-header">
        ...
        <div className="review-modal-ratings-container">
          <div
            ...
            style={{
              backgroundColor:
                rating === 5 ? "rgba(112, 112, 112, 0.06)" : null,
            }}
          ...
          <div
            ...
            style={{
              backgroundColor:
                rating === 4 ? "rgba(112, 112, 112, 0.06)" : null,
            }}
          ...
          <div
            ...
            style={{
              backgroundColor:
                rating === 3 ? "rgba(112, 112, 112, 0.06)" : null,
            }}
          ...
          <div
            ...
            style={{
              backgroundColor:
                rating === 2 ? "rgba(112, 112, 112, 0.06)" : null,
            }}
          ...
          <div
            ...
            style={{
              backgroundColor:
                rating === 1 ? "rgba(112, 112, 112, 0.06)" : null,
            }}
        ...
        />
        {!rating ? null : (
          <button className="review-modal-post-review-btn">
            {reviewLoader ? (
